...
public class WhiteboardMarker : MonoBehaviour
{
    ...
    {
        //Debug to see ray
        Debug.DrawRay(tip.position, tip.transform.forward / 0.9f, Color.red, 0.01f);

        //Find out if pen tip is touching the whiteboard
        if (Physics.Raycast(tip.position, tip.transform.forward, out raycastResult, tipHeight))
        {
